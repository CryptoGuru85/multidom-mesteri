    ...
    return(
        <div className={classes.profileContainer}>
            <div className={classes.profileHeader}>
                ...
                <div>
                    <Typography className={classes.profileName}>{profileState && `${profileState.first_name} ${profileState.last_name}`}</Typography>
                    <Typography className={classes.profileRole}>{profileState.role && profileState.role.name}</Typography>
                    <Typography className={classes.profileLocation}> <LocationOnIcon/>{profileState&& profileState.city}</Typography>
                </div>
                <div style={{display: 'flex', alignSelf: "end", marginLeft: 100}}>
                    <button onClick={mobileToggle} className={classes.callButton}><PhoneIcon style={{width: '24px', height: '24px', margin: 10}}/>{showMobileState ? profileState.mobile : 'Apeleaza'}</button>
            ...
            <div className={classes.profileBody}>
                <div className={classes.profileMain}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between', marginBottom: 20}}>
                        <div className={classes.bodyHeaderIcon}>
                            ...
                            <div className={classes.bodyHeaderLabelContainer}>
                                <Typography className={classes.bodyHeaderLabel}>{profileState.experience}-ani</Typography>
                                <Typography className={classes.bodyHeaderLabelSub}>Experienta</Typography>
                            </div>
                        </div>
                        ...
                        <div className={classes.bodyHeaderIcon}>
                            <Groups/>
                            <div className={classes.bodyHeaderLabelContainer}>
                                <Typography className={classes.bodyHeaderLabel}>{profileState.team}</Typography>
                                <Typography className={classes.bodyHeaderLabelSub}>Echipa</Typography>
                            </div>
                        </div>
                        ...
                        <div className={classes.bodyHeaderIcon}>
                            <EuroIcon/>
                            <div className={classes.bodyHeaderLabelContainer}>
                                <Typography className={classes.bodyHeaderLabel}>{profileState.price_estimate ? 'Da' : 'Nu'}</Typography>
                                <Typography className={classes.bodyHeaderLabelSub}>Pret constatare</Typography>
                            </div>
                        </div>
                    </div>
                    ...
                    <Typography className={classes.bodyHeader}>Servicii oferite</Typography>
                    <Divider style={{marginTop: 20, marginBottom: 20}}/>
                    {
                    ...
                    <Typography style={{marginTop: 20}} className={classes.bodyHeader}>Portofoliu</Typography>
                    <Divider style={{marginTop: 20, marginBottom: 20}}/>
                        <Grid container>
                        {
                            ...
                            profileState.projects.map((data, index) => (
                                <Grid key={index} item>
                                    <Avatar className={classes.project} src={data.profile_picture} />
                                </Grid>
                            ))
                        }
                    </Grid>
                ...
                <div className={classes.profileRight}>
                    ...
                    <Typography className={classes.profileLocation}> <LocationOnIcon/> {profileState&& profileState.city}</Typography>
                    <img className={classes.locationImage} src="https://cdn.discordapp.com/attachments/926446798065778718/934898639212515379/unknown.png"/>
                </div>
            </div>
        </div>
    )
