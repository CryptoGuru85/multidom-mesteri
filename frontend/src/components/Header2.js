...
function Header(props) {
    ...
    console.log("State", filterInputState)
    ...
    <>
        ...
        <div className={classes.search}>
                <div className={classes.search_top}>
                    <div><Typography className="filter-label">Caută dupa serviciu</Typography></div>
                    <div style={{display: 'flex', alignItems: 'center', color: '#185ABC'}}><DisabledByDefaultIcon/><Typography className="filter-label">Clear filters</Typography></div>
                </div>
                <input 
        ...
        <div>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', width: '75%'}}>
                    <FormControlLabel control={<Checkbox/>} checked={companyState} onChange={
                        event => {
                    ...
                    <FormControlLabel control={<Checkbox />} checked={individualState} onChange={
                        event => {
        ...
        <Button 
            ...
            fullWidth 
            onClick={handleDrawerToggle}>Filtrează</Button>
        </div>
    </>
  );
...
export default connect(mapStateToProps, {getProfileList, logout})(withRouter(Header));
